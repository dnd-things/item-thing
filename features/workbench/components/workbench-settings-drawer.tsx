          ...
          <FieldGroup className="flex flex-col gap-6 px-6 py-5">
            ...
            {!isMinimalStyle ? (
              <>
                ...
                />
                <Field>
                  <FieldLabel htmlFor="drawer-card-width">
                    Card width
                  </FieldLabel>
                ...
                />
                <Field>
                  <FieldLabel htmlFor="drawer-image-size">
                    Image size
                  </FieldLabel>
                  <div className="flex h-9 items-center gap-3 rounded-xl border border-primary/8 bg-input/10 px-4">
                    <Slider
              ...
              <Field>
                <FieldLabel>Minimal style</FieldLabel>
                <p className="rounded-xl border border-primary/8 bg-input/10 px-4 py-3 text-sm leading-6 text-muted-foreground">
                  Minimal uses a fixed portrait composition. Layout, framing,
                  and artwork transform controls are disabled for this style.
                </p>
              </Field>
            )}
          </FieldGroup>
