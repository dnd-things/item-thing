...
export function PreviewSurface({ workbenchState }: PreviewSurfaceProps) {
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              The {selectedCardStyleLabel.toLowerCase()} style is still pending.
              Switch to Print to preview the card renderer.
            </p>
          </div>
        </div>
      )}
